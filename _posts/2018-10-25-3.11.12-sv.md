...
🍰 Förbättrat
 * Utseendet i integrations har förbättrats ytterligare för bättre användarvänlighet.
 ...
 * Gone fishing i integrations visade formateringsmeddelande felaktigt.
 * Långa frågetexter gjorde att inlägg och historik inte visades i högerpanelen.
 * Rader och discipliner visar samma radhöjder när det finns riktigt många rader.
