 ...
 * The My Commitments board has received several improvements:
   ...
   - Rows now behave differently for My Commitments:
     ...
     - For each plan that you have tasks assigned to yourself, but no row, a "non-sticky" row is created. Non-sticky rows are removed from the view when they become empty.
