...
🍰 Enhancements
 * The styling of integrations has been improved further for better usability
 ...
 * Gone fishing in integrations is not showing format options incorrectly anymore
 * Long question texts resulted in posts and history being hidden in details panel
 * Rows and trades are correctly showing right row heights when there is many rows
